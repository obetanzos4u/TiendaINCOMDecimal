<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/bootstrap/basic.master" CodeFile="pedido-envio - Copia.aspx.cs" Inherits="usuario_cliente_basic" %>
...
<asp:Content runat="server" ContentPlaceHolderID="body">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="btn-group">
                <asp:HyperLink ID="link_envio" runat="server"  class="btn btn-primary active" aria-current="page">
                    <span class="h4">Envío</span><br />
                    <span>Elige el método de envío</span>
                </asp:HyperLink>
                <asp:HyperLink ID="link_datos" runat="server"   class="btn btn-outline-primary " aria-current="page">
    ...
    <div class="container-md">
        <div class="row">
            <div class="col">
                <h1 class="h1">Método Envio</h1>
                <h1 class="h2">para el pedido
                    <asp:Literal ID="lt_numero_pedido" runat="server"></asp:Literal></h1>
                <p>Establece el tipo de envio, usa una de tus direcciones guardadas o agrega una nueva.</p>
            </div>
        ...
        <p><strong>Selecciona un método de envío de envío</strong></p>
  ...
  <div class="col">  <div class="row row-cols-1 row-cols-sm-1  row-cols-md-2  row-cols-lg-2  row-cols-xl-2">
           <div class="col mb-4">
            <div id='contentCard_DireccEnvio' class="card " runat="server"  >
                 <img src="/img/webUI/Icon-recoge-en-tienda.gif" class="card-img-top" alt="...">
                <div id="card_envio_recoge_en_tienda"  class="card-body">
                    <h5 class="card-title">Recoger en tienda</h5>
                    <p class="card-text">
                      Recoge en nuestras sucursales, CDMX, Monterrey y Jilotepec (Edo. Mex.)
                    </p>  <br />
    ...
    <asp:ListView ID="lv_direcciones" OnItemDataBound="lv_direcciones_ItemDataBound" runat="server">
            ...
            <div class="col mb-4">
                <div id='contentCard_DireccEnvio' class="card " runat="server">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-secondary  text-dark bg-light" href="editar-direccion-envio.aspx">Editar</a>
        ...
        </div>        <div class="form-row">            <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-6  col-lg-3 col-xl-2">
          ...
          <div class="form-row">
              <div class="form-group col-md-6">   <label for="<%= txt_colonia.ClientID %>">Colonia</label>
