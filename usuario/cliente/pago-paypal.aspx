...
<asp:Content runat="server" ContentPlaceHolderID="body">
    ...
    <div class="container">
        <div class="is-flex is-justify-start is-items-start">
            ...
            <button type="button" title="Copiar número de operación" class="is-cursor-pointer" style="background-color: transparent; outline: none; border: none;" onclick="copiarNumeroParte('body_lt_numero_operacion', 'Número de pedido')">
