...
public partial class usuario_cliente_editar_contacto : System.Web.UI.Page
{
    ...
    protected void btn_editar_contacto_Click(object sender, EventArgs e)
    {
        ...
        if (result.result)
        {
            ...
            NotiflixJS.Message(this, NotiflixJS.MessageType.success, "Contacto actualizado con éxito");
        ...
        {
            NotiflixJS.Message(this, NotiflixJS.MessageType.failure, "Error al actualizar el contacto");
