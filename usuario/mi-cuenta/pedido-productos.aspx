<%@ Page Language="C#" AutoEventWireup="true"   Async="true" MaintainScrollPositionOnPostback="true" CodeFile="pedido-productos.aspx.cs"
    ...
    <div id="content_productos" runat="server" class="container">
        ...
        <div class="row">
             <div class="col s12 m6 l6 xl6">
                  <h1 class="margin-b-2x">Productos de 
            ...
            <div style="float: right;" class="col s12 m6 l5 xl5 right-align  ">
                ...
                <div id="content_descuento" visible="false" runat="server">
                    Sub Total  <strong>
                        <asp:Label ID="lbl_subtotalSinDescuento" runat="server"></asp:Label></strong><br />
                 ...
                 <div class="col m12 l12   right-align " style="padding: 1rem 10px;">
                     <asp:HyperLink ID="link_pago" 
                         CssClass="waves-effect waves-light btn-large blue" runat="server">
                ...
                <div class="col m12 l12   right-align " style="padding: 1rem 10px;">
                    ...
                    <div id="content_envioUsuario" runat="server" visible="false" class="input-field inline">
                        ...
                        <br />
                        <asp:LinkButton ID="btn_guardarMetodoEnvio" OnClick="btn_guardarMetodoEnvio_Click" runat="server">Guardar Envio</asp:LinkButton>
                        <div>
                            <label>
            ...
            <asp:ListView ID="lv_productosCotizacion" OnItemDataBound="lv_productos_OnItemDataBound" runat="server">
                <LayoutTemplate>
                    <div class="row line-bottom ">
                        ...
                        <div class="col s12 m3 l3 right-align"><strong>Precio Total</strong>
                ...
                <ItemTemplate>
                    <div class="row">
                        <div class="col s12 m3 l2">
                         ...
                         <asp:HyperLink ID="link_imgProducto" Target="_blank" runat="server">     <asp:Image ID="imgProducto" CssClass="responsive-img" runat="server" />
                     </asp:HyperLink>
                        ...
                        <div class="col s12 m4 l5">
                            ...
                            <div>Precio Unitario:<strong> 
                                <asp:Label ID="lbl_precio_unitario" runat="server"></asp:Label></strong>   <span class=" blue-grey lighten-5 nota">Impuestos <strong>No incluidos</strong> </span><br /></div>
                            <div><%#Eval("descripcion") %></div>
                            <br />
                            <strong>
                                                              <asp:UpdatePanel UpdateMode="Always" runat="server">
                                    <ContentTemplate>
                                        <asp:LinkButton CssClass="btn btn-s deep-orange text-darken-1" OnClientClick="btnLoading(this);" 
                        ...
                        <div class="col s12 m3 l3 right-align">
                            <asp:Label ID="lbl_precio_total" runat="server"></asp:Label>  <span class=" blue-grey lighten-5 nota">Impuestos <strong>No incluidos</strong> </span><br />
                        </div>
                        <div class="col s12 m3 l2 right-align">
                            <asp:HiddenField ID="hf_cantidadPedido" Value='<%#Eval("cantidad") %>' runat="server" />
                            <asp:TextBox ID="txt_cantidadPedido" Enabled="false"  CssClass="txtCantidad" AutoPostBack="true" type="number" onchange="txtLoading(this);"
                                Text='<%#Eval("cantidad") %>' OnTextChanged="txt_cantidadPedido_TextChanged" runat="server"></asp:TextBox>
                        </div>
