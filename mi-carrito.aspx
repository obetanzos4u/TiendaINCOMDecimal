                                            ...
                                            <asp:UpdatePanel UpdateMode="Always" runat="server">
                                                <ContentTemplate>
                                                    <div style="width: 4rem;">
                                                        <asp:TextBox ID="txt_cantidadCarrito" TextMode="Number" min="1" max="12" onchange="txtLoading(this);" AutoPostBack="true" Text='<%#Eval("cantidad") %>' OnTextChanged="txt_cantidadCarrito_TextChanged" Style="border-radius: 10px; text-align: center" runat="server"></asp:TextBox>
                                                    </div>
                                                </ContentTemplate>
                                                <Triggers>
