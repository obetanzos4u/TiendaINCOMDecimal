        ...
        <div class="row">
            ...
            <div class="col s12  m3 l4 xl4">
                ...
                <asp:LinkButton ID="btn_ConsultarPedidos" OnClick="btn_ConsultarPedidos_Click" CssClass="btn blue"
                    runat="server">Consultar Pedidos</asp:LinkButton>
            </div>
                        ...
                        <div class="card ">
                            ...
                            <div class="card-content">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:Label ID="lbl_estatus_pago" runat="server">     </asp:Label>
                                            </td>
                                ...
                                <asp:UpdatePanel ID="up_desglose_pedido" UpdateMode="Conditional" style="height: 160px;" runat="server">
                                    <ContentTemplate>
                                        Estatus operacion:
                                 <strong>  <asp:Label ID="lbl_OperacionCancelada" runat="server"><%# Eval("PedidoDatos.OperacionCancelada") %> </asp:Label></strong> 
                                        <hr>
                                        <asp:Panel ID="ContentPedidoDesactivar" runat="server">
                                            ...
                                            <asp:LinkButton ID="btn_desactivar_pedido"
                                                OnClick="btn_desactivar_pedido_Click" CssClass="btn-small blue-grey-text  blue-grey lighten-4" runat="server">Cancelar</asp:LinkButton>
                                        ...
                                        <asp:Panel ID="ContentPedidoActivar" runat="server">
                                            ...
                                            <asp:LinkButton ID="btn_activar_pedido" OnClick="btn_activar_pedido_Click"
                                                CssClass="btn-small blue-grey-text  blue-grey lighten-4" runat="server">Reactivar Pedido</asp:LinkButton>
