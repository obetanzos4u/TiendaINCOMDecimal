    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m3 l4 xl4">
                ...
                <asp:TextBox ID="txt_fecha_desde" runat="server" type="date"></asp:TextBox>
            </div>
            <div class="col s12  m3 l4 xl4">
                <label>Fecha hasta:</label>
                <asp:TextBox ID="txt_fecha_hasta" runat="server" type="date"></asp:TextBox>
            </div>
            <div class="col s12  m3 l4 xl4">
                <br/>
                <asp:LinkButton ID="btn_ConsultarPedidos" OnClick="btn_ConsultarPedidos_Click" CssClass="" runat="server">
            ...
            <div class="col s12 m12 l6 xl6">
                <table>
                    ...
                    <tr>
                        ...
                        <td><asp:Label ID="lbl_total_registros" runat="server"></asp:Label></td>
                        <td>Monto MXN Productos s/n Impuestos</td>
                        <td><asp:Label ID="lbl_MontoProductos_MXN_Sin_Impuestos" runat="server"></asp:Label></td>
                    </tr>
                </table>
            </div>
            <div class="col s12 m12 l6 xl6">
                <asp:GridView ID="gv_desgloseMeses"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TotalPedidosMes" HeaderText="# Pedidos"
                          ...
                          <asp:BoundField DataField="MontoTotalMesSNImpuestos" HeaderText="Monto Productos $"
                            SortExpression="MontoTotalMesSNImpuestos" />
                         <asp:BoundField DataField="TotalPedidosPagados" HeaderText="Pago"
                    ...
                    <div class="col s12 m6 xl4" style="margin-bottom: 10px;">
                        <div class="card card-reporte_pedidos">
                            ...
                            <div class="card-content">
                                <p class="is-text-black" style="float: right; font-size: 0.75rem;">
                                    <%#String.Format("{0:f}",  Eval("PedidoDatos.fecha_creacion")) %>
                                </p>
                                <div class="is-inline-block is-top-2 is-w-full">
                                    ...
                                    <p style="padding-left: 5px;">Número de operación: <span class="is-font-bold is-mx-2"><%# Eval("PedidoDatos.numero_operacion") %></span></p>
                                </div>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr class="is-flex">
                                            ...
                                            <td class="is-flex" style="width: 280px;"><%#String.Format("{0:C}",   Eval("PedidoDatosNumericos.total")) %>      <%# Eval("PedidoDatosNumericos.monedaPedido") %></td>
                                        </tr>
                                        <tr class="is-flex" style="height: 100px;">
                                            ...
                                            <td class="is-flex" style="width: 280px;"><asp:Label ID="lbl_estatus_pago" style="margin: auto 0px !important;" runat="server"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <span class="hide"><%#Container.DataItemIndex %></span>
                                <asp:UpdatePanel ID="up_desglose_pedido" UpdateMode="Conditional" style="height: 220px;" runat="server">
                                    <ContentTemplate>
                                        <div class="text-estatus_reporte_pedido is-flex is-top-1" style="padding-bottom: 1rem; border-bottom: 1px solid #252525;">
                                        <p class="is-flex" style="width: 100px; padding-left: 5px;">Estatus:</p>
                                        <strong><asp:Label ID="lbl_OperacionCancelada" class="is-text-xl is-font-semibold is-flex is-items-center" style="width: 280px;" runat="server"><%# Eval("PedidoDatos.OperacionCancelada") %></asp:Label></strong>
                                        </div>
