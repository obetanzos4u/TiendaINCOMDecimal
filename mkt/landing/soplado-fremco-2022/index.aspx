            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        <h1>Webinar</h1>
                        <h1>"Soplado de fibra óptica"</h1>
                        <h2>Conoce más sobre la innovadora técnica de soplado de fibra óptica con INCOM y FREMCO</h2>
                        <h2>Jueves 20 de octubre | 10:00 AM</h2>
                        <div class="text-center text-lg-start">
                            <a href="#contact" class="btn-get-started scrollto bg-danger">¡Inscríbete!</a>
                        </div>
                    </div>
                </div>
