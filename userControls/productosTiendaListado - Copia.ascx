<%@ Control Language="C#" AutoEventWireup="true" CodeFile="productosTiendaListado - Copia.ascx.cs" Inherits="userControls_productosTiendaListado" %>
...
<div class="row" style="margin: auto 0px !important;">
    ...
    <div class="col s12 m12 l12 xl12 " style="margin: auto 0px !important; min-height: 330px;">
        <div runat="server" id="content_resultado_busqueda_text" visible="false"  style="position: sticky;
    top: 100px;
    background: white;
    z-index: 99;
    overflow: auto;
    height: 53px;">
            <h2 style="margin: 0px; line-height: 50px;">Resultado de la búsqueda de: <span class="blue-text">
             <asp:HyperLink ID="linkTerminoBusqueda" runat="server"></asp:HyperLink>   <asp:Literal ID="lt_termino_busqueda" runat="server"></asp:Literal></span></h2>
        </div>
                ...
                <asp:ListView ID="lv_productos" OnItemDataBound="lv_productos_OnItemDataBound" runat="server">
                    <LayoutTemplate>
                        <div class="row">
                            <asp:DataPager ID="dp_1" class="dataPager_productos" runat="server" Visible="true" PagedControlID="lv_productos"
                                PageSize="100" QueryStringField="PageId">
                                <Fields>
                    ...
                    <ItemTemplate>
                        <div id="item_producto" runat="server" class="cajaProductosFCO ">
                            <div  style="padding: 0px !important" class="card ">
                                <div class='card-image waves-effect waves-block waves-light content_imgProducto_<%# Eval("numero_parte") %>' >
                                ...
                                <div class="card-content descripciónProductoListado" style="padding-top: 12px;">
                                    ...
                                    <p style="line-height: 20px;">
                                        ...
                                        <asp:Label ID="lbl_producto_moneda" CssClass="producto_moneda" runat="server" Text=""></asp:Label>
                                         <br />
                                     </p>   <div style="font-size: 14px;"><%# Eval("unidad_venta") %> (<%# Eval("cantidad") %>  <%# Eval("unidad") %>)</div> 

                                   
                                    <div><span style="inline-size: -webkit-fill-available; white-space: nowrap;overflow: hidden;"
                                        class=" blue-grey lighten-5 nota">Impuestos <strong>No incluidos</strong> </span></div>
                                    ...
                                    <div>
                                        ...
                                        <uc_visualizarProducto:link ID="linkVisualizarProducto" Visible="false"  runat="server"></uc_visualizarProducto:link>
                                          ...
                                          <a id="btn_VerDisponibilidad"  runat="server"    class="waves-effect waves-light btn btn-full-text blue modal-trigger" style="margin-top: 5px;" 
                    ...
                    <EmptyDataTemplate>
                        <div class="row center-align" style="height:150px;">
                            ...
                            <h3>Navega entre nuestros productos o intenta con otro término</h3>
                        </div>
                    </EmptyDataTemplate>
                </asp:ListView>
...
<div id="modal_slideShow_productos" class="modal modal-fixed-footer" style="width:700px">
    <div class="modal-content">
        <h4 id="titulo" runat="server"><a id="link_productoSlideShow">Ver detalles del producto</a> </h4>
