...
<asp:DropDownList ID="ddl_pais" class="form-control" AutoPostBack="true" runat="server">
    ...
    <asp:ListItem Text="Bosnia And Herzegowina" Value="BA"></asp:ListItem>
    ...
    <asp:ListItem Text="Cote D'Ivoire" Value="CI"></asp:ListItem>
    <asp:ListItem Text="Croatia (Local Name: Hrvatska)" Value="HR"></asp:ListItem>
    ...
    <asp:ListItem Text="Heard And Mc Donald Islands" Value="HM"></asp:ListItem>
    ...
    <asp:ListItem Text="Icel And" Value="IS"></asp:ListItem>
    ...
    <asp:ListItem Text="Korea, Dem People'S Republic" Value="KP"></asp:ListItem>
    ...
    <asp:ListItem Text="Lao People'S Dem Republic" Value="LA"></asp:ListItem>
    ...
    <asp:ListItem Selected="True" Text="México" Value="MX"></asp:ListItem>
    <asp:ListItem Text="Micronesia, Federated States" Value="FM"></asp:ListItem>
    ...
    <asp:ListItem Text="Netherlands Ant Illes" Value="AN"></asp:ListItem>
    ...
    <asp:ListItem Text="Saint K Itts And Nevis" Value="KN"></asp:ListItem>
    <asp:ListItem Text="Saint Lucia" Value="LC"></asp:ListItem>
    <asp:ListItem Text="Saint Vincent, The Grenadines" Value="VC"></asp:ListItem>
    ...
    <asp:ListItem Text="Slovakia (Slovak Republic)" Value="SK"></asp:ListItem>
    ...
    <asp:ListItem Text="South Georgia , S Sandwich Is." Value="GS"></asp:ListItem>
    ...
    <asp:ListItem Text="St. Pierre And Miquelon" Value="PM"></asp:ListItem>
    <asp:ListItem Text="Sudan" Value="SD"></asp:ListItem>
    <asp:ListItem Text="Suriname" Value="SR"></asp:ListItem>
    <asp:ListItem Text="Svalbard, Jan Mayen Islands" Value="SJ"></asp:ListItem>
    <asp:ListItem Text="Sw Aziland" Value="SZ"></asp:ListItem>
    ...
    <asp:ListItem Text="Turks And Caicos Islands" Value="TC"></asp:ListItem>
    ...
    <asp:ListItem Text="United States Minor Is." Value="UM"></asp:ListItem>
    ...
    <asp:ListItem Text="Viet Nam" Value="VN"></asp:ListItem>
    ...
    <asp:ListItem Text="Zaire" Value="ZR"></asp:ListItem>
