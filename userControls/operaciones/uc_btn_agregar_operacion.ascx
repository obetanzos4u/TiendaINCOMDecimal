...
<asp:UpdatePanel ID="UP_cantidadCarrito" Visible="false" RenderMode="Inline" runat="server">
    <ContentTemplate>
        <asp:HiddenField ID="hf_numero_parte" runat="server" />
        <asp:HiddenField ID="hf_descripcion_corta" runat="server" />

        <asp:LinkButton ID="btn_MostrarModal" OnClick="btn_MostrarModal_Click" runat="server" class="is-btn-blue" Text="Cotización"></asp:LinkButton>
    </ContentTemplate>
    <Triggers>
