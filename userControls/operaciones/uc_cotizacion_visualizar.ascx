|<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_cotizacion_visualizar.ascx.cs" Inherits="userControls_cotizacion_visualizar" %>

<asp:HiddenField ID="hf_id" runat="server" />
<asp:HiddenField ID="hf_usuario_email" runat="server" />
<div id="content_operacion" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        style="font-size: 14px; background: #1a163114; color: #525252;">
        <tbody style="font-family: Helvetica,Arial,sans-serif; text-align: left;">
            <tr>
                <td>
                    <table id="content_operacion_center" style="font-family: Helvetica,Arial,sans-serif; background: white;" runat="server" width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>&nbsp; </td>
                            </tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="3" style="text-align: center;">
                                                    <img id="logo_header" alt="Incom.mx" src="<%= Request.Url.GetLeftPart(UriPartial.Authority)%>/img/webUI/company_logo_wide.jpg" width="654" height="64">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" style="background-color: #ffd133   !important;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr id="header_infoBasica" runat="server">
                                                <td colspan="3" height="33">Estimado(a):
                      <strong>
                          <asp:Label ID="lbl_cliente_nombre" runat="server"></asp:Label></strong>
                                                    <br>
                                                    Gracias por cotizar en INCOM, a continuación presentamos la información detallada:<br>
                                                    <hr />
                                                    <asp:Label ID="lbl_nombre_cotizacion" lang="nombre_cotizacion" runat="server"></asp:Label>
                                                    |  Número de operación #: <strong>
                                                        <asp:Label ID="lbl_numero_operacion" lang="numero_operacion" runat="server"></asp:Label>
                                                    </strong>
                                                    <br>
                                                    Fecha de creación de operación: <strong>
                                                        <asp:Label ID="lbl_fecha_creacion" lang="fecha_creacion" runat="server"></asp:Label>
                                                    </strong>
                                                    &nbsp; | &nbsp; 
                          Vigencia: 
                                <strong>
                                    <asp:Label ID="lbl_vigencia" lang="fecha_creacion" runat="server"></asp:Label>
                                    días.   </strong>
                                                    <br>
                                                </td>
                                            </tr>
                                            ...
                                            <asp:Label ID="lbl_envio_colonia" lang="envio_colonia" runat="server"></asp:Label>
                                                            ...
                                                            <tr>
                                                                <td colspan="3" style="background-color: rgb(0, 103, 199); color: white; font-weight: bold; padding: 5px; text-align: left;">Condiciones de envío:
                                                               
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3">Método de envío:
                                                                    <asp:Label ID="lbl_metodoEnvio" runat="server"></asp:Label>
                                                                    &nbsp;  </td>
                                                            </tr>
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td colspan="3" style="background-color: rgb(0, 103, 199); color: white; 
font-weight: bold; padding: 5px; text-align: left;">Comentarios:
                                                             ...
                                                             <tr>
                                                                <td colspan="3" style="background-color: rgb(0, 103, 199); color: white; 
font-weight: bold; padding: 5px; text-align: left;">Condiciones:
                                                               
                                                                </td>
                                                                <tr>
                                                                    <td colspan="3">
                                                                    <div>    <asp:Label ID="lbl_TerminoTiempoEntrega" runat="server"></asp:Label></div>
                                                                     <div>     <asp:Label ID="lbl_TerminoFormaDePago" runat="server"></asp:Label></div>
                                                                      <div>    <asp:Label ID="lbl_TerminoEntrega" runat="server"></asp:Label></div>
                                                                   <br />
                                                                       <strong>UNA VEZ CONFIRMADO EL PEDIDO NO SE ACEPTA CANCELACIÓN, DEVOLUCIÓN NI CAMBIO DE NINGUNA ESPECIE. </strong>
                                                ...
                                                <td colspan="3">
                                                    <div lang="compra">
                                                        <asp:ListView ID="lv_productos" OnItemDataBound="lv_productos_ItemDataBound" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr style="font-size: 12px; page-break-inside: avoid; text-align: left; <%# Container.DisplayIndex % 2 == 0 ? "": "background-color:#efefef;" %>">
                                                                    <td style="text-align: left;">
                                                                      ...
                                                                      <asp:Label ID="lbl_lvProductos_titulo" runat="server"></asp:Label>
                                                                                        ...
                                                                                        <asp:HyperLink ID="link_lvProductos_linkPDF" runat="server">
                                                                                            <asp:Image ID="img_lvProductos_linkPDF" style="height:28px; width:28px;" runat="server" />
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" style="color: rgba(25, 25, 25, 0.8);">
                                                                                        <strong><asp:Label ID="lbl_lvProductos_alternativo" runat="server" ></asp:Label></strong>
                                          ...
                                          <tr id="content_subtotalSinDescuento" runat="server">
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><strong> Sub Total : </strong></td>
                                                <td style="text-align: right">
                                                    <asp:Label ID="lbl_subtotalSinDescuento" lang="subtotalSinDescuento" runat="server"></asp:Label></td>
                                            </tr>
                                           <tr id="content_descuento_porcentaje" runat="server">
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><strong>Descuento aplicado:  </strong></td>
                                                <td style="text-align: right">
                                                   <asp:Label ID="lbl_descuento_porcentaje" lang="descuento_porcentaje" runat="server"></asp:Label>%</td>
                                            </tr>
     
                                              <tr>
                                                <td>&nbsp;</td>
                                                <td width="184" style="text-align: right"><strong>Sub Total antes de IVA:: </strong></td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><strong>Tipo de cambio del día de emisión de este documento: </strong></td>
                                                <td style="text-align: right">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left; font-size: 14px;">
                                                    ...
                                                    <ul>
                                                        <li>Todas las cotizaciones en pesos (MXN) tendrán vigencia de 1 día.</li>
                                                        <li> Los precios indicados en esta cotización, están sujetos a cambio por desabasto, aumento en materias primas o la imposición de aranceles e incluido cualquier cambio representativo en el mercado.
Nos reservamos el derecho de no surtir órdenes de compra o hacerlo parcialmente.</li>
                                                        <li>Las cotizaciones realizadas en pesos (MXN) serán vigentes únicamente si la variación en el tipo de cambio no supere 5% de diferencia de lo establecido en este documento.  </li>
                                                        <li>Los precios aquí mostrados deberán ser cubiertos en su totalidad a: <strong>Insumos Comerciales de Occidente S.A de C.V.</strong></li>
