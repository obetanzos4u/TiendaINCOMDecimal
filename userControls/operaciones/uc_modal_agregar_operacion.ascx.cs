...
public partial class uc_modal_agregar_operacion : System.Web.UI.UserControl
{
    ...
    protected void loadCotizaciones()
    {
        ...
        if (Session["cotizacion_edit"] != null && Session["cotizacion_edit_idSQL"] != null)
        {
            ...
            lbl_numero_operacion.Text = "Operación: " + dtCotizacionEdit.Rows[0]["numero_operacion"].ToString();
        ...
        {
            lbl_nombre_operacion.Text = "Cotización";
            lbl_numero_operacion.Text = "Número de operación: ---";
            lbl_moneda.Text = "---";
