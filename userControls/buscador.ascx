...
<div class="buscador_container">
    <asp:TextBox ID="txt_buscadorProducto" placeholder="Buscar" Style="padding-left: 0.5rem;" name="buscador" ClientIDMode="Static" autocomplete="some-random-string" runat="server"></asp:TextBox>
