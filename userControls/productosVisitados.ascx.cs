...
public partial class uc_productosVisitados : System.Web.UI.UserControl
{
    ...
    public void obtenerProductos()
    {
        ...
        slidesToShow = slidesToShow == null ? 5 : slidesToShow;
        string str_verticalMode = "false";
        if (verticalMode != null){
            str_verticalMode = verticalMode.ToString().ToLower(); ; }

        string sliderJS = @"console.log('test'); document.addEventListener('DOMContentLoaded', function(event) {  
                               $('.sliderVisitados').slick({
                                    slidesToShow: " + slidesToShow + @",
                                     vertical : " + str_verticalMode + @",
                                     infinite: true,
                                     autoplay: true
                                });
                            });   ";
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Slider", sliderJS, true);
