...
<%--            <div class="btn_carrito_left">
            ...
            <div class="txt_center">
                ...
                <asp:TextBox ID="txt_cantidadCarrito" Style="text-align: center; height: 1.5rem; width: -webkit-fill-available; padding: 3px; border-radius: 12px; margin-bottom: 1rem;" class="inline txt_cantidadCarrito" Text="1"
