    ...
    <ContentTemplate>
        <div class="counter_carrito">
            ...
            <div class="txt_center">
                <asp:TextBox ID="txt_cantidadCarrito" TextMode="Number" Type="Integer" Style="text-align: center; font-size: 14px; height: 1.25rem; line-height: 1.25rem; width: -webkit-fill-available; padding: 3px; border-radius: 12px; margin-bottom: 1rem;" Text="1"
...
<asp:UpdatePanel ID="up_btn_add_carrito" style="display: inline;" runat="server">
    <ContentTemplate>
        ...
        <a id="agregar_productoCarrito_logoOut" runat="server" visible="false" class="agregar_carrito agregar_carrito-out waves-effect-1 waves-light btn-2" style="background: #108A00 !important; border-radius: 6px; text-transform: none; font-weight: 600;">Agregar al carrito
        </a>
    </ContentTemplate>
    <Triggers>
